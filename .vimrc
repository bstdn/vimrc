...
Plugin 'altercation/vim-colors-solarized' "主题风格 素雅 solarized
Plugin 'tomasr/molokai' "主题风格 多彩 molokai
Plugin 'vim-scripts/phd' "主题风格 复古 phd
Plugin 'Lokaltog/vim-powerline' "美化状态栏
"Plugin 'octol/vim-cpp-enhanced-highlight' "对 C++ 语法高亮支持
Plugin 'nathanaelkane/vim-indent-guides' "缩进可视化插件
"Plugin 'derekwyatt/vim-fswitch' "接口与实现快速切换
"Plugin 'kshenoy/vim-signature' "代码收藏
"Plugin 'vim-scripts/BOOKMARKS--Mark-and-Highlight-Full-Lines' "书签行高亮
"Plugin 'majutsushi/tagbar' "基于标签的标识符列表
"Plugin 'vim-scripts/indexer.tar.gz' "代码导航
"Plugin 'vim-scripts/DfrankUtil' "代码导航
"Plugin 'vim-scripts/vimprj' "代码导航
"Plugin 'dyng/ctrlsf.vim' "内容查找
Plugin 'terryma/vim-multiple-cursors' "快捷替换
Plugin 'scrooloose/nerdcommenter' "快速开关注释
"Plugin 'vim-scripts/DrawIt' "ASCII art 风格注释
...
"Plugin 'gcmt/wildfire.vim' "快速编辑结对符
"Plugin 'sjl/gundo.vim' "支持分支的 undo
Plugin 'Lokaltog/vim-easymotion' "快速移动
"Plugin 'suan/vim-instant-markdown' "markdown 即时预览
"Plugin 'lilydjwg/fcitx.vim' "中/英输入平滑切换
"Plugin 'tpope/vim-fugitive' "处理 git merge 文件冲突 命令:Gstatus
Plugin 'Shougo/neocomplcache.vim' "Vim 自动补全
Plugin 'vim-scripts/EasyGrep' "快速搜索替换多个文件
